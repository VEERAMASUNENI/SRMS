...
> A browser-based tool for comparing two texts using the **Longest Common Subsequence** dynamic programming algorithm, with a live DP matrix, similarity score, and matched subsequence highlighting.
...
All processing happens in your browser. Uploaded `.txt` files are read locally and are not sent to a server.
...
- The **DP Matrix** is capped at 30×30 for display, and very large inputs are blocked to keep the browser responsive
